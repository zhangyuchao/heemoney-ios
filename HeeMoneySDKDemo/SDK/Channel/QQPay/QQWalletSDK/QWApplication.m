...
#endif
//
NSString* const kQWAppKeyName_QQ = @"name";
NSString* const kQWAppKeyUrlScheme_QQ = @"urlScheme";
NSString* const kQWAppKeySDKVersion_QQ = @"sdkVersion";
NSString* const kQWAppKeyAPPID_QQ =  @"appId";
...
- (NSDictionary*) dictionaryWithAllValues{
    return [self dictionaryWithValuesForKeys:@[kQWAppKeyUrlScheme_QQ, kQWAppKeySDKVersion_QQ, kQWAppKeyName_QQ, kQWAppKeyAPPID_QQ]];
}
@end
